...
impl Display for TicketNewError {
    // The return "fmt::Result" follows the example: https://doc.rust-lang.org/std/fmt/trait.Display.html#examples
    // Because TicketNewError contains TitleError and DescriptionError, we match each of them
