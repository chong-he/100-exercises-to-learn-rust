...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        // validate the title, description and status when creating a new ticket
    ...
    pub fn set_title(&mut self, new_title: String) {
        // when we want to update/modify the field, we also need to make sure the modification follows the same rule
        // so we need to validate here also
